    ...
    md:flex-row justify-center items-center gap-4 md:gap-8 mb-5">
      ...
      <div className="flex flex-col flex-1 gap-2">
        <div className="flex items-center gap-6 mb-1">
          <div className="relative w-20 h-14 flex-shrink-0 flex gap-3 items-center justify-center 
           hover:scale-105 cursor-pointer group">
            <img src={StreakIcon} alt="streak" className="w-7 h-7" />
            <span className="text-orange-500 font-bold text-sm">{streak}</span>
            <div className="absolute -top-3 left-1/2 -translate-x-1/2 px-2 py-1 bg-black 
            text-white text-xs rounded shadow opacity-0 group-hover:opacity-100 pointer-events-none transition-opacity z-10 whitespace-nowrap">
              Current streak
            </div>
          </div>
          <div className="relative w-20 h-14 flex-shrink-0 flex gap-3 items-center justify-center 
